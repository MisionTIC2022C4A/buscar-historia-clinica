...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Patient',
            fields=[
                ('numero_identificacion', models.CharField(max_length=255, primary_key=True, serialize=False)),
                ('tipo_identificacion', models.CharField(max_length=255)),
                ('aseguradora', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('nombre_acompanante', models.CharField(blank=True, max_length=255, null=True)),
                ...
                ('vinculacion', models.CharField(blank=True, max_length=255, null=True)),
            ],
            options={
                'db_table': 'patient',
                'managed': False,
